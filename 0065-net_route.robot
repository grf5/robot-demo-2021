...
${PRIMARY_STATIC_ROUTE_LIST}            %{PRIMARY_STATIC_ROUTE_LIST}
${PRIMARY_STATIC_ROUTEv6_LIST}            %{PRIMARY_STATIC_ROUTEv6_LIST}
${PRIMARY_STATIC_DEFAULT_ROUTE}            %{PRIMARY_STATIC_DEFAULT_ROUTE}
${PRIMARY_STATIC_DEFAULTv6_ROUTE}            %{PRIMARY_STATIC_DEFAULTv6_ROUTE}
${SECONDARY_STATIC_ROUTE_LIST}            %{SECONDARY_STATIC_ROUTE_LIST}
${SECONDARY_STATIC_ROUTEv6_LIST}            %{SECONDARY_STATIC_ROUTEv6_LIST}
${SECONDARY_STATIC_DEFAULT_ROUTE}            %{SECONDARY_STATIC_DEFAULT_ROUTE}
${SECONDARY_STATIC_DEFAULTv6_ROUTE}            %{SECONDARY_STATIC_DEFAULTv6_ROUTE}
