...
Create the IPv4 Peers
    ...
    set log level  trace
    ${ipv4_peer_list}    convert string to json    ${BGP_PRIMARY_SINGLE_CONTEXT_IPv4_PEERS}
    ...
    END    
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    ${ipv4_peer_list}    convert string to json    ${BGP_SECONDARY_SINGLE_CONTEXT_IPv4_PEERS}
    FOR    ${current_neighbor}    IN    @{ipv4_peer_list}
        ${neighbor_host}    get from dictionary    ${current_neighbor}    neighbor
        ${neighbor_peer_group}    get from dictionary    ${current_neighbor}    peer-group
        ${neighbor_description}    get from dictionary    ${current_neighbor}    description
...
Create the IPv6 Peers
    ...
    set log level  trace
    ${ipv6_peer_list}    convert string to json    ${BGP_PRIMARY_SINGLE_CONTEXT_IPv6_PEERS}
    ...
    END    
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    ${ipv6_peer_list}    convert string to json    ${BGP_SECONDARY_SINGLE_CONTEXT_IPv6_PEERS}
    FOR    ${current_neighbor}    IN    @{ipv6_peer_list}
        ${neighbor_host}    get from dictionary    ${current_neighbor}    neighbor
        ${neighbor_peer_group}    get from dictionary    ${current_neighbor}    peer-group
        ${neighbor_description}    get from dictionary    ${current_neighbor}    description
