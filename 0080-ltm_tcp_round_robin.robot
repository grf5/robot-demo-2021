...
Create TCP DNS Round-Robin Test Pool
    ...
    set log level    trace
    Create an LTM Pool    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_POOL_MONITOR}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Create an LTM Pool    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_POOL_MONITOR}

Verify TCP DNS Round-Robin Test Pool
    [Documentation]    Verifies the existence and configuration of the pool object
    set log level    trace
    Verify an LTM Pool    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_POOL_MONITOR}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Verify an LTM Pool    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_POOL_MONITOR}

Create TCP DNS Round-Robin IPv6 Test Pool
    [Documentation]    Creates the pool object for the back-end pool members
    set log level    trace
    Create an LTM Pool    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_IPV6_POOL_MONITOR}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Create an LTM Pool    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_IPV6_POOL_MONITOR}

Verify TCP DNS Round-Robin IPv6 Test Pool
    [Documentation]    Verifies the existence and configuration of the pool object
    set log level    trace
    Verify an LTM Pool    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_IPV6_POOL_MONITOR}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Verify an LTM Pool    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}    monitor=${TCP_ROUND_ROBIN_IPV6_POOL_MONITOR}
...
Create TCP DNS Round-Robin Virtual Server
    ...
    set log level    trace
    Create an LTM FastL4 Virtual Server    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}   destination=${TCP_ROUND_ROBIN_VIP_ADDRESS}:${TCP_ROUND_ROBIN_VIP_PORT}  pool=${TCP_ROUND_ROBIN_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Create an LTM FastL4 Virtual Server    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}   destination=${TCP_ROUND_ROBIN_VIP_ADDRESS}:${TCP_ROUND_ROBIN_VIP_PORT}  pool=${TCP_ROUND_ROBIN_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled

Verify TCP DNS Round-Robin Virtual Server
    [Documentation]    Verifies the existence and configuration of a virtual server
    set log level    trace
    Verify an LTM FastL4 Virtual Server    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}   destination=${TCP_ROUND_ROBIN_VIP_ADDRESS}:${TCP_ROUND_ROBIN_VIP_PORT}  pool=${TCP_ROUND_ROBIN_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Verify an LTM FastL4 Virtual Server    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}   destination=${TCP_ROUND_ROBIN_VIP_ADDRESS}:${TCP_ROUND_ROBIN_VIP_PORT}  pool=${TCP_ROUND_ROBIN_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled

Create TCP DNS Round-Robin IPv6 Virtual Server
    [Documentation]    Creates a virtual server object that listens for traffic and forwards to the appropriate pool/next-hop
    set log level    trace
    Create an LTM FastL4 IPv6 Virtual Server    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_VIP_NAME}   destination=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}.${TCP_ROUND_ROBIN_IPV6_VIP_PORT}  pool=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_IPV6_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_IPV6_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Create an LTM FastL4 IPv6 Virtual Server    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_VIP_NAME}   destination=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}.${TCP_ROUND_ROBIN_IPV6_VIP_PORT}  pool=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_IPV6_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_IPV6_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled

Verify TCP DNS Round-Robin IPv6 Virtual Server
    [Documentation]    Verifies the existence and configuration of a virtual server
    set log level    trace
    Verify an LTM FastL4 IPv6 Virtual Server    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_VIP_NAME}   destination=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}.${TCP_ROUND_ROBIN_IPV6_VIP_PORT}  pool=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_IPV6_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_IPV6_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Verify an LTM FastL4 IPv6 Virtual Server    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_IPV6_VIP_NAME}   destination=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}.${TCP_ROUND_ROBIN_IPV6_VIP_PORT}  pool=${TCP_ROUND_ROBIN_IPV6_POOL_NAME}   ipProtocol=${TCP_ROUND_ROBIN_IPV6_VIP_PROTOCOL}    mask=${TCP_ROUND_ROBIN_IPV6_VIP_MASK}    sourceAddressTranslation_type=${TCP_ROUND_ROBIN_VIP_SNAT_TYPE}    sourceAddressTranslation_pool=none    translateAddress=enabled    translatePort=enabled
...
Set the VIP to advertise itself
    ...
    set log level    trace
    Configure Route Health Injection on a Virtual Address    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    address=${TCP_ROUND_ROBIN_VIP_ADDRESS}    route-advertisement=always 
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'    
    Configure Route Health Injection on a Virtual Address    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    address=${TCP_ROUND_ROBIN_VIP_ADDRESS}    route-advertisement=always

Set the IPv6 VIP to advertise itself
    [Documentation]    Configures the virtual address (listening address/destination address) to be announced via BGP
    set log level    trace
    Configure Route Health Injection on a Virtual Address    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    address=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}    route-advertisement=always 
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'    
    Configure Route Health Injection on a Virtual Address    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    address=${TCP_ROUND_ROBIN_IPV6_VIP_ADDRESS}    route-advertisement=always
...
Show Statistics for TCP DNS Round-Robin Virtual Server
    ...
    set log level    trace
    Retrieve LTM Virtual Server Statistics    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Retrieve LTM Virtual Server Statistics    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_VIP_NAME}
...
Show Statistics for TCP DNS Round-Robin Pool
    ...
    set log level    trace
    Retrieve LTM Pool Statistics    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Retrieve LTM Pool Statistics    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    name=${TCP_ROUND_ROBIN_POOL_NAME}
...
Show Statistics for TCP DNS Round-Robin Pool Members
    ...
    set log level    trace
    Retrieve LTM Pool Member Statistics    bigip_host=${PRIMARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    pool_name=${TCP_ROUND_ROBIN_POOL_NAME}
    Return from Keyword If    '${SECONDARY_MGMT_IP}' == 'false'
    Retrieve LTM Pool Member Statistics    bigip_host=${SECONDARY_MGMT_IP}    bigip_username=${HTTP_USERNAME}    bigip_password=${HTTP_PASSWORD}    pool_name=${TCP_ROUND_ROBIN_POOL_NAME}
